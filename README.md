...
build/scalopus_example$ rm -rf * ; CXX=/usr/bin/clang++-7 cmake ../../repo/scalopus_examples/ -DScalopusTransport_DIR=$(pwd)/../scalopus_transport/ -DScalopusLttng_DIR=$(pwd)/../scalopus_lttng/ && make
```
